...
import { useAddTaskMutation, useDeleteTaskMutation, useGetTasksQuery, useUpdateTaskMutation } from "./api";
...
export default function Home() {
 ...
 console.log("delete", useDeleteTaskMutation())
 const {data: getTasks, isLoading, isError, error } = useGetTasksQuery()
